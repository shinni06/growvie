...
('Q006', 'Meatless Monday', 'Eat a vegetarian meal. Upload a pic of your greens!', '🥗', 3, 50, 'Waste Reduction', 'USR001', 'Inactive', '2026-01-31'),
('Q007', 'Trash Tag', 'Pick up litter in your neighborhood. Show us the bag.', '🚮', 5, 100, 'Community', 'USR001', 'Inactive', '2026-01-31'),
('Q008', 'Thrift Haul', 'Buy something second-hand instead of new.', '👕', 4, 80, 'Waste Reduction', 'USR001', 'Inactive', '2026-01-31');
...
('QS005', 'Q002', 'USR004', 'tote bags for life ', 'Pending', '2025-11-28'),
('QS006', 'Q001', 'USR002', 'Used my reusable bottle throughout the day on campus.', 'Pending', '2025-12-10'),
('QS007', 'Q001', 'USR006', 'Brought my own bottle to the gym instead of buying drinks.', 'Pending', '2025-12-11'),
('QS008', 'Q002', 'USR007', 'Used a reusable bag while grocery shopping.', 'Pending', '2025-12-12'),
('QS009', 'Q002', 'USR008', 'Carried my own tote bag to the convenience store.', 'Pending', '2025-12-13'),
('QS010', 'Q003', 'USR009', 'Prepared lunch using reusable containers and cutlery.', 'Pending', '2025-12-11'),
('QS011', 'Q003', 'USR010', 'Packed homemade lunch in reusable boxes.', 'Pending', '2025-12-12'),
('QS012', 'Q004', 'USR011', 'Took public transport instead of driving.', 'Pending', '2025-12-13'),
...
('QS018', 'Q001', 'USR023', 'Hydrated and sustainable.', 'Pending', '2025-12-08'),
('QS019', 'Q004', 'USR022', 'Took the bus to work today.', 'Pending', '2025-11-18'),
...
('RT001', 'VP011', 'PO001', 'Sabah, Malaysia', '5.978°N, 116.075°E', 'Hill A', '2025-12-14', 'Approved'),
('RT002', 'VP008', 'PO002', 'Penang, Malaysia', '5.4164°N, 100.3327°E', 'Forest B', '2025-12-14', 'Approved'),
('RT003', 'VP013', 'PO003', 'Perak, Malaysia', '4.592°N, 101.090°E', 'Forest Reserve C', '2025-11-25', 'Pending'),
('RT004', 'VP015', 'PO001', 'Sarawak, Malaysia', '1.553°N, 110.359°E', 'National Park D', '2026-01-09', 'Pending'),
('RT005', 'VP003', 'PO002', 'Selangor, Malaysia', '3.0738°N, 101.5183°E', 'Shah Alam Community Park', '2025-12-28', 'Approved'),
('RT006', 'VP005', 'PO001', 'Pahang, Malaysia', '4.3820°N, 102.2400°E', 'Taman Negara Buffer Zone', '2025-12-30', 'Approved'),
('RT007', 'VP007', 'PO005', 'Sarawak, Malaysia', '1.6110°N, 110.1500°E', 'Kuching Wetlands', '2026-01-02', 'Pending'),
('RT008', 'VP010', 'PO003', 'Johor, Malaysia', '1.4854°N, 103.7618°E', 'Endau-Rompin Park', '2026-01-03', 'Approved'),
('RT009', 'VP019', 'PO004', 'Kedah, Malaysia', '6.1184°N, 100.3685°E', 'School Greening Project A', '2026-01-05', 'Pending'),
('RT010', 'VP020', 'PO002', 'Kuala Lumpur, Malaysia', '3.1390°N, 101.6869°E', 'Urban Rooftop Garden', '2026-01-10', 'Approved');
...
('UP020', 'USR026', 1, 100, 10, 2, 0, 1, 'Active'),
