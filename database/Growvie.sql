...
CREATE TABLE `plant` (
  `plant_id` varchar(6) NOT NULL,
  `plant_name` varchar(255) NOT NULL,
  `plant_desc` varchar(255) NOT NULL,
  `drops_required` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `plant_request` (
  `plant_request_id` varchar(6) NOT NULL,
  `user_id` varchar(6) NOT NULL,
...
CREATE TABLE `quest` (
  `quest_id` varchar(6) NOT NULL,
  `quest_title` varchar(100) NOT NULL,
  `quest_description` varchar(255) NOT NULL,
  `quest_emoji` varchar(2) NOT NULL,
  `drop_reward` int(11) NOT NULL,
  `eco_coin_reward` int(11) NOT NULL,
...
CREATE TABLE `quest_submission` (
  ...
  `quest_id` varchar(6) NOT NULL,
  `user_id` varchar(6) NOT NULL,
  `quest_submission_description` varchar(255) NOT NULL,
  `proof_code` varchar(255) NOT NULL,
...
CREATE TABLE `quest_submission_vote` (
  `vote_id` varchar(6) NOT NULL,
  `user_id` varchar(6) NOT NULL,
  `submission_id` varchar(6) NOT NULL,
...
CREATE TABLE `real_tree_record` (
  `real_tree_id` varchar(6) NOT NULL,
  `virtual_plant_id` varchar(6) NOT NULL,
  `partner_id` varchar(6) NOT NULL,
  `location` varchar(100) NOT NULL,
  `coordinates` varchar(50) NOT NULL,
  `planting_site` varchar(100) NOT NULL,
...
CREATE TABLE `shop_item` (
  ...
  `item_image_code` varchar(255) NOT NULL,
...
CREATE TABLE `user_player` (
  `user_player_id` varchar(6) NOT NULL,
  `user_id` varchar(6) NOT NULL,
  `player_tier` int(11) NOT NULL,
  `eco_coins` int(11) NOT NULL,
  `drops_progress` int(11) NOT NULL,
  `total_quests_completed` int(11) NOT NULL,
  `tree_planted_irl` int(11) NOT NULL,
  `growvie_plants_planted` int(11) NOT NULL,
...
CREATE TABLE `virtual_plant` (
  `virtual_plant_id` varchar(6) NOT NULL,
  `user_id` varchar(6) NOT NULL,
  `plant_id` varchar(6) NOT NULL,
  `current_stage` int(11) NOT NULL,
  `drops_used` int(11) NOT NULL,
...
--
-- Indexes for table `plant_request`
--
ALTER TABLE `plant_request`
  ADD PRIMARY KEY (`plant_request_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indexes for table `quest_submission`
--
...
--
-- Indexes for table `quest_submission_vote`
--
...
--
-- Indexes for table `real_tree_record`
--
ALTER TABLE `real_tree_record`
  ADD PRIMARY KEY (`real_tree_id`),
  ADD KEY `virtual_plant_id` (`virtual_plant_id`),
...
ALTER TABLE `user_player`
  ADD PRIMARY KEY (`user_player_id`),
  ADD KEY `user_id` (`user_id`);
...
--
-- Indexes for table `virtual_plant`
--
ALTER TABLE `virtual_plant`
  ADD PRIMARY KEY (`virtual_plant_id`),
  ADD KEY `user_id` (`user_id`),
